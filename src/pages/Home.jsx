...
export default function Home() {
  ...
  // PWA Kontrolü: Uygulama modunda mı yoksa tarayıcıda mı?
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-950 to-black text-white">
      ...
      {/* DÜZELTME: pt-48 ile içerik aşağı itildi */}
      <main className="max-w-6xl mx-auto px-4 pt-48 pb-16 flex flex-col items-center min-h-[80vh]">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-10 leading-relaxed">Sana en yakın salonu bul, saniyeler içinde randevunu oluştur.</p>
                ...
                <div className="max-w-md mx-auto flex items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="text-left">
                            <p className="text-sm font-bold text-white">Tıraş Randevum</p>
                            <p className="text-xs text-gray-400">Daha iyi bir deneyim için</p>
                        </div>
                    </div>
                    <button 
                        onClick={() => setIsInstallOpen(true)}
                        className="bg-blue-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg hover:bg-blue-500 transition-colors whitespace-nowrap"
                    >
                        Uygulamayı Yükle
                    </button>
                </div>
